...
export const CartProvider = ({ children }) => {
  ...
  //Will re-calculate the cartCount everytime the cartItems changes
  useEffect(() => {
  ...
  //We could use the previous effect but a good pratice is to keep only one responsability by effect
  useEffect(() => {
